...
namespace imgui_addons
{
    ...
    bool ImGuiFileBrowser::renderNavAndSearchBarRegion()
    {
        ...
        ImGui::BeginChild("##NavigationWindow", nw_size, ImGuiChildFlags_AutoResizeX | ImGuiChildFlags_AutoResizeY | ImGuiChildFlags_AlwaysAutoResize, ImGuiWindowFlags_NoScrollbar);
        ...
        ImGui::SameLine();
        ImGui::BeginChild("##SearchWindow", sw_size, ImGuiChildFlags_AutoResizeX | ImGuiChildFlags_AutoResizeY | ImGuiChildFlags_AlwaysAutoResize, ImGuiWindowFlags_NoScrollbar);
